...
class AuvDreamerTorchPolicy(TorchPolicyV2):
    ...
    def loss(
        ...
        print(f"{image_pred.mean.shape = }")
        print(f"{image_pred = }")
        print(f"{latent.shape = }")
        print(f"{features.shape = }")
        print(f"{post[0].shape = }")
        print(f"{prior[0].shape = }")
        print(f"{train_batch['obs'].shape = }")
        print(f"{train_batch['obs'].unsqueeze(1).shape = }")
        print(f"{train_batch['obs'] = }")
        print(f"{train_batch['rewards'].shape = }")
        print(f"{reward_pred.mean.shape = }")
